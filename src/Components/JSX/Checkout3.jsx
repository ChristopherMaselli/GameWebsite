...
const Checkout = (props) => {
  ...
  const [chargeInfo, setChargeInfo] = useState({
    ...
    cardNumber: CardElement.cardNumber,
    cardExpYear: 2021,
    cardExpMonth: 7,
    cardCvc: "123",
  ...
  const handleChangeForm = (e) => {
    const tempBillingDetails = { ...billingDetails };
    const value = e.currentTarget.value;
    const name = e.currentTarget.name;
    tempBillingDetails[name] = value;
  ...
  return paymentMethod ? (
    ...
    <Form>
      <Form.Group className="Form" onSubmit={handleSubmit}>
        <Form.Label className="FormGroup2">
          <Form.Control
            as="input"
            name="name"
            ...
            onChange={(nameRef) => handleChangeForm(nameRef)}
          />
          <Form.Control
            as="input"
            label="Email"
            ...
            onChange={(emailRef) => handleChangeForm(emailRef)}
          />
          <Form.Control
            as="input"
            label="Phone"
            ...
            onChange={(phoneRef) => handleChangeForm(phoneRef)}
          />
        </Form.Label>
        <CardField
          onSubmit={(e) => {
